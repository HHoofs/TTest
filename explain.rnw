...
<<"ENKEL_V2_K_KGEBIED", echo=FALSE,fig.width=10, fig.height=6.5, fig.env="figure", fig.align="center", fig.pos="!ht", fig.cap="Indicatie waar het kritieke gebied zich bevind.">>=
mu = 7
mean = 7.2
sd = 1
...
Omdat het aantal personen in onze steekproef niet is veranderd en de hypothese ook gelijk is gebleven blijft de kritieke grenswaarde exact gelijk aan het vorige voorbeeld (er is hier slecht \'e\'en kritiek gebied omdat we nog steeds eenzijdig toetsen), dus we kunnen de waarde weer overnemen in het plaatje

<<"ENKEL_V2_K_KWAARDE", echo=FALSE,fig.width=10, fig.height=6.5, fig.env="figure", fig.align="center", fig.pos="!ht", fig.cap="Verdeling van de compleetheid in percentages voor alle variabelen.">>=
#T.crit
t.crit <- qt(p=alpha, N-1,lower.tail=FALSE)
...
Wat ons nog rest is om deze t-waarde in te vullen en de conclusie te trekken of de t-waarde wel of niet in het kritieke gebied valt:
<<"ENKEL_V2_K_TWAARDE", echo=FALSE,fig.width=10, fig.height=6.5, fig.env="figure", fig.align="center", fig.pos="!ht", fig.cap="Verdeling van de compleetheid in percentages voor alle variabelen.">>=
#T.crit
t.crit <- qt(p=alpha, N-1,lower.tail=FALSE)
t.value <- (mean-mu)/(sd/sqrt(N-1))
...
<<"ENKEL_V2_P_TWAARDE", echo=FALSE,fig.width=10, fig.height=6.5, fig.env="figure", fig.align="center", fig.pos="!ht", fig.cap="Verdeling van de compleetheid in percentages voor alle variabelen.">>=
# P Value right sided ------------------------------------------------------
